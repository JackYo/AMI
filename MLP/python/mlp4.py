...
def predict2(sol='lbfgs', hidden_layer=50, max_it=150, warm=False, shuf=False, random_s=1,acti="logistic"):
	...
	for k in range(0,1):
		...
		# use logistic
		mlp = pyrenn.CreateNN([3,4,4,4,4,4,4,4,1],dIn=[1,2,3,4,5,6,7],dIntern=[],dOut=[1,2,3,4,5,6,7])
		mlp = pyrenn.train_LM(X,y,mlp,verbose=True,k_max=200,E_stop=1e-3)
	...
	output_file_name = "../output/output4-" + str(num)
